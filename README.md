...
1.) Whether the recipient has responded to any of my previous emails
...
Email 1,2,3: Email Content. The first time a lead gets an email, he gets email 1. The next time, he gets email 2. Etc.

2.)Click "tools", and select "script editor"

3.) Copy and paste the code into the script editor

4.) Update/configure the code as necessary to match your purposes
